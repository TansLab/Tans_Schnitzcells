...
if ~isempty(framesWithCellsChangingAfterDivision) %NW2015-05 (new matlab version -> empty matrix became size(0,1)?!
        % apply if condition also above if running into errors
