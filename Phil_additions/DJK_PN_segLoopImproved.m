    ...
    for i2 = array_segRange
      for i3 = [1:size(array_array_edgeSlices,1)]
        for i4 = [1:size(array_array_fillingEdgeSlices,1)]
          ...
          DJK_PN_segmoviephaseImproved(p, 'minCellLengthConservative',20,'removeSmallCells',removeSmallCells,'segRange',i2,'edgeSlices',i3Nrs,'minNumEdgePixels',i1,'fillingEdgeSlices',i4Nrs,'botHatSize',i0,'DJK_saveDir',directory); 
