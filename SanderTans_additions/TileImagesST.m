...
% p = TileImagesST(p,'numphaseslices',1,'NrTilesX',5,'NrTilesY',5,'EnlargeFact',1.3,'tileRange',1:25);

% p = TileImagesST(p,'numphaseslices',1,'NrTilesX',7,'NrTilesY',5,'EnlargeFact',1.3,'tileRange',1:35);
%
