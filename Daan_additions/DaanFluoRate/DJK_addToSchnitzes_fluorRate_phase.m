...
%d_sum = ['d' upper(colorfield) '_sum'];
%d_sum_dt = ['d' upper(colorfield) '_sum_dt'];
%d_sum_dt_ph = ['d' upper(colorfield) '_sum_dt_ph'];
%d_sum_dt_vol = ['d' upper(colorfield) '_sum_dt_vol'];
%sum_all = [upper(colorfield) '_sum_all'];
