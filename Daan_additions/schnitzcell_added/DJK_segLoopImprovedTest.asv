function DJK_segLoopImprovedTest(p, array_segRange, array_array_edgeSlices, array_array_fillingEdgeSlices, array_minNumEdgePixels, array_botHatSize, removeSmallCells) 
% DJK_segLoopImproved
%
    ...
    for i2 = array_segRange
      for i3 = [1:size(array_array_edgeSlices,1)]
        for i4 = [1:size(array_array_fillingEdgeSlices,1)]
          ...
          % _maxCellWidth7 _maxThreshCut0.5 _removeSmallCells0
          % _mask_2_bigger _minCellLengthConservative14 _edge_lapofgauss_sigma_4
          extra_string_filename = '_edge_lapofgauss_sigma_2.5';
          if ~removeSmallCells
          ...
          DJK_segmoviephaseImproved(p, 'edge_lapofgauss_sigma', 2.5, 'minCellLengthConservative',20,'removeSmallCells',removeSmallCells,'segRange',i2,'edgeSlices',i3Nrs,'minNumEdgePixels',i1,'fillingEdgeSlices',i4Nrs,'botHatSize',i0,'DJK_saveDir',directory); 
