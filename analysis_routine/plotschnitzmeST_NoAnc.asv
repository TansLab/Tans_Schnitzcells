function [xout,yout,Xbr,Xsw,Xdv] = plotschnitzmeST_NoAnc(p,schnitzcells, xfield, yfield, whichones, styleMap, varargin)

%ADDITION ST-NoAnc:
% The command will only show the plot of schnitzes of interest without their parents. 
% Also, there is a regression done in between 2 points clicked on the schnitz mention LAST.
% It is best to mention the switching schnitz last.
