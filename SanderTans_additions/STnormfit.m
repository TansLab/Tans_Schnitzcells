function [muhat, sigmahat, muci, sigmaci] = STnormfit(x,alpha,censoring,freq,options)
...
%   $Revision: 2.17.4.7 $  $Date: 2004/04/16 22:22:02 $
...
if nargout > 2
    ...
    logsigci = norminv(probs, log(sigmahat), se(2)./sigmahat);
