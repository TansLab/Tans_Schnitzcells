 function p = makeminimovieSTc(p,varargin) 
...
while i<=imax
    ...
    imy = imread([p.imageDir,p.movieName,'-c-',str3(frame),'.tif']);
%     imy = imy + 600 - BG;
...
outpathFy = [newp.imageDir,newp.movieName,'-c-'];
% frames
